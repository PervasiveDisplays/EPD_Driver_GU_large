...
# EPD_Driver Demo
 *  The sample code implements a global update functionality for a [9.7" Spectra R2.0 EPD (TE2969JS0B2)](https://www.pervasivedisplays.com/product/2-71-e-ink-display-spectra-r2-0/).  
