> [!WARNING]
> This library is deprecated. It is only kept to support global/normal update for BWR or Spectra EPDs. If you are using BW wide-temperature with Fast Update support, you need to use the latest library here: https://github.com/PervasiveDisplays/Pervasive_Wide_Large
